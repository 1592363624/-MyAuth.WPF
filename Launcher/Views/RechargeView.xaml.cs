...
namespace LoginLauncher.Views
{
    ...
    /// Register.xaml 的交互逻辑
    /// </summary>
    public partial class RechargeView : Page
    {
        public RechargeView()
        {
            InitializeComponent();
            this.DataContext = DataSource.registrData;
            Loaded += RechargeView_Loaded;
        }


        private void Regbutton_Click(object sender, RoutedEventArgs e)
        {
            if (DataSource.register.SoftRegister() == "注册成功")
            {
        ...
        {
            Debug.WriteLine(txt_pass.Text);
        }

        private void RechargeView_Loaded(object sender, RoutedEventArgs e)
        {
            // 创建一个平移动画
